...
var IntermediateGen = {
  generate: function(tgnRoot, tmpFolder, projectFolder, sourceFolder, componentFolder, component) {
    ...
    execSync(tgnRoot + '/node_modules/babel-cli/bin/babel.js ' + projectFolder + '/' + sourceFolder + ' --out-dir '+ tmpFolder + ' --no-babelrc --presets react,es2015,stage-0 --plugins transform-decorators-legacy');
