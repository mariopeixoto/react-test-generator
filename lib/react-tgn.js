...
var argv = require('yargs')
    .usage('Usage: $0 [options] <project_folder> <target>')
    .default('source-folder', '.')
    .describe('source-folder', 'Source folder under the project folder')
    .alias('source-folder', 's')
    .default('component-folder', '.')
    .describe('component-folder', 'Component folder under the source folder')
    .alias('component-folder', 'c')
    .demand(2)
    .help('h')
    .alias('h', 'help')
    .argv;
...
var target = argv._[1];
var sourceFolder = argv.s;
var componentFolder = argv.c;
